...
pstacks_cmd = "pstacks -f {} -o /media/Shared/Data/chum/populations/pstacks/batch_3 -i {} --model_type bounded --bound_high 0.05 --alpha 0.05 -m 1 -p 6 -t bam"
...
sstacks_cmd = "sstacks -b 3 -c batch_3 -o /media/Shared/Data/chum/populations/pstacks/batch_3 -p 6 -g -s {} "
